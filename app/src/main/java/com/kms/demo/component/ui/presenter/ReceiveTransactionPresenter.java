...
import com.kms.demo.component.ui.view.BackupWalletActivity;
 ...
 */
public class ReceiveTransactionPresenter extends BasePresenter<ReceiveTransactionContract.View> implements ReceiveTransactionContract.Presenter {

    private Wallet wallet;

    public ReceiveTransactionPresenter(ReceiveTransactionContract.View view) {
        super(view);
    ...
    @Override
    public void copyPublickWalletAddress() {
        if (isViewAttached()) {
    ...
    @Override
    public void enterBackupWalletPage() {
        if (isViewAttached()) {
            BackupWalletActivity.actionStart(getContext(), wallet);
        }
    }
}
