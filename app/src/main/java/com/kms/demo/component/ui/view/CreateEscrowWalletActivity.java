...
import com.kms.demo.component.ui.presenter.CreateEscrowWalletPresenter;
 ...
 */
public class CreateEscrowWalletActivity extends MVPBaseActivity<CreateEscrowWalletPresenter> implements CreateEscrowWalletContract.View {
    ...
    @Override
    protected CreateEscrowWalletPresenter createPresenter() {
        return new CreateEscrowWalletPresenter(this);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_escrow_wallet);
    ...
    private void initViews() {
        ...
        RxTextView.textChanges(etWalletName).skipInitialValue().subscribe(new Consumer<CharSequence>() {
            @Override
            public void accept(CharSequence charSequence) throws Exception {
                mPresenter.checkCreateWalletButton();
            }
        });

        RxTextView.textChanges(etWalletPassword).skipInitialValue().subscribe(new Consumer<CharSequence>() {
            @Override
            public void accept(CharSequence charSequence) throws Exception {
                mPresenter.checkCreateWalletButton();
            }
        ...
        RxTextView.textChanges(etRepeatWalletPassword).skipInitialValue().subscribe(new Consumer<CharSequence>() {
            @Override
            public void accept(CharSequence charSequence) throws Exception {
                mPresenter.checkCreateWalletButton();
            }
    ...
    public static void actionStart(Context context) {
        Intent intent = new Intent(context, CreateEscrowWalletActivity.class);
