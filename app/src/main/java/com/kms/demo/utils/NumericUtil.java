...
public class NumericUtil {
    ...
    public static String encode(String data) {
        ...
        BigInteger value = new BigInteger(data.getBytes());
    ...
    public static String encodeQuantity(BigInteger value) {
        if (value.signum() != -1) {
            ...
            throw new MessageEncodingException("Negative values-en are not supported");
        }
    }

    public static BigInteger decodeQuantity(String value, BigInteger defaultValue) {
