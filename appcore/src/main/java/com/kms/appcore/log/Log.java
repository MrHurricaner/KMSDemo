...
public class Log {
    ...
    private static final boolean FORCE_LOG_TO_FILE = true;
    ...
    public static String getCurrentLogFilePath() {
        Logger logger = loggerMap.get(FILE_COMMON_LOG);
        if (logger == null) {
            return Environment.getExternalStorageDirectory().getAbsolutePath() + "/yap/log/log/saleLog";
        }
