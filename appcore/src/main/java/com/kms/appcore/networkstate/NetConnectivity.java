...
public class NetConnectivity {
    ...
    public static final String ACITION_CONNECTIVITY_CHANGE = "com.kms.appcore.conn.CONNECTIVITY_CHANGE";
    public static final String EXTRA_NETSTATE = "com.kms.appcore.conn.EXTRA_NETSTATE";
