 ...
 */
package com.kms.appcore.fs;

import android.content.Context;
import android.os.Environment;
import android.text.TextUtils;

import com.kms.appcore.config.DirType;
...
public class DirectroyContext {
     ...
     * 一天的毫秒数
     */
    protected static final long ONE_DAY_MS = 1000 * 60 * 60 * 24L;
    /**
     * 一秒的毫秒数
     */
    protected static final long ONE_SECOND_MS = 1000;
