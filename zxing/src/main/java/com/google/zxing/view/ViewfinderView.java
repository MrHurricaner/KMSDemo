...
public final class ViewfinderView extends View {
    ...
    private static int CORNER_RECT_WIDTH = 16;  //扫描区边角的宽
    private static int CORNER_RECT_HEIGHT = 80; //扫描区边角的高
    ...
    //扫描区域提示文本颜色
    private final int topLabelTextColor;
    private final float topLabelTextSize;
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        labelTextColor = array.getColor(R.styleable.ViewfinderView_label_text_color, 0xF1F0FD);
        labelText = array.getString(R.styleable.ViewfinderView_label_text);
        labelTextSize = array.getDimensionPixelSize(R.styleable.ViewfinderView_label_text_size, sp2px(context, 12f));

        topLabelTextColor = array.getColor(R.styleable.ViewfinderView_top_label_text_color, 0xF1F0FD);
        topLabelText = array.getString(R.styleable.ViewfinderView_top_label_text);
        topLabelTextSize = array.getDimensionPixelSize(R.styleable.ViewfinderView_top_text_size, sp2px(context, 16f));

        CORNER_RECT_WIDTH = dp2px(getContext(), 3f);
        CORNER_RECT_HEIGHT = dp2px(getContext(), 20f);
    ...
    private void drawTopTextInfo(Canvas canvas, Rect frame) {
        paint.setColor(topLabelTextColor);
        paint.setTextSize(topLabelTextSize);
        paint.setTextAlign(Paint.Align.CENTER);
        canvas.drawText(topLabelText, frame.left + frame.width() / 2, frame.top - dp2px(getContext(), 16f), paint);
    }
    ...
    private void drawTextInfo(Canvas canvas, Rect frame) {
        ...
        canvas.drawText(labelText, frame.left + frame.width() / 2, frame.bottom + dp2px(getContext(), 16f) + textHeight, paint);
    }
